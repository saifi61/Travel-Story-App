...
const TravelStoryCard = ({
    ...
    return (
        ...
        hover:shadow-slate-200 transition-all ease-in-out relative cursor-pointer'>
            ...
            <button
                className='w-12 h-12 flex items-center justify-center bg-white/40 rounded-lg border border-whit/30 absolute top-4 right-4'
            ...
            <div className='p-4' onClick={onClick}>
                ...
                bg-cyan-200/40 rounded mt-3 px-2 py-1'>
